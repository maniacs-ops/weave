...
// getVethNetdevs outputs veths identified by the given indexes in the format of
// weavenet.Dev.
func getVethNetdevs(args []string) error {
	if len(args) != 1 {
		cmdUsage("veth-netdevs", "<iface-index>[,<iface-index>]")
	}
